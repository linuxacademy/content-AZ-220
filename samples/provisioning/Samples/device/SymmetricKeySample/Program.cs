...
namespace SymmetricKeySample
{
    class Program
    {
        ...
        private const string enrollmentGroupPrimaryKey = "Ii8rr6S+QZ3+hkMZL+TM+daqBmtu3Ta0FMi7PV6KPsDxp7pF8mBro88Sv63rPCkwbQH+lUsj0C3WjHK4d3n4aA==";
        private const string enrollmentGroupSecondaryKey = "v3Knw1D+x6zII/DshhnaykDV7UNNH0KWO+lCPKR03HE+yF3QLePe9m1idnyhFTHuyoBITSWw2ELo/JRH+xkdeA==";
        ...
        public static int Main(string[] args)
        {
            ...
            string primaryKey = "";
            string secondaryKey = "";
            if (!String.IsNullOrEmpty(s_registrationID) && !String.IsNullOrEmpty(enrollmentGroupPrimaryKey) && !String.IsNullOrEmpty(enrollmentGroupSecondaryKey))
            {
                ...
                primaryKey = ComputeDerivedSymmetricKey(Convert.FromBase64String(enrollmentGroupPrimaryKey), s_registrationID);
                secondaryKey = ComputeDerivedSymmetricKey(Convert.FromBase64String(enrollmentGroupSecondaryKey), s_registrationID);
            }
            else if (!String.IsNullOrEmpty(s_registrationID) && !String.IsNullOrEmpty(individualEnrollmentPrimaryKey) && !String.IsNullOrEmpty(individualEnrollmentSecondaryKey))
            {
        ...
        /// <param name="s_registrationID">the registration id to create</param>
